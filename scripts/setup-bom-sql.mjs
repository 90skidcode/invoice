  ...
  try {
    ...
    for (const itemData of itemsToCreate) {
      ...
      await sql`
        ...
        VALUES (${itemId}, ${org.id}, ${itemData.sku}, ${itemData.name}, ${gramUnitId}, ${taxRateId}, '0', ${itemData.is_finished_good ? true : false}, true, ${org.created_by}, ${org.created_by})
      `;
    ...
    await sql`
      ...
      VALUES (${bomId}, ${org.id}, ${finishedGood}, 1, 'Rose bath bar recipe', '1500', ${gramUnitId}, '250', '0', 'Rose bath bar - 1500g batch', true, 'active', ${org.created_by}, ${org.created_by})
    `;
